...
$hGUI = GUICreate("Example 16 - GUIControlRenderer", 400, 400)
...
$oProgress1 = _MoGraph_ShapeCreateRectangle(0, 0, _MoGraph_TimeLoopCreate(_MoGraph_EaseValueCreate(0, 380, 0, 100), 0, 100), 40, _MoGraph_SolidBrushCreate(0, 200, 255))
...
$oProgress2 = _MoGraph_ShapeCreateRectangle(_MoGraph_TimeLoopCreate(_MoGraph_EaseValueCreate(-150, 380, 0, 150), 0, 150), 0, 150, 40, _MoGraph_SolidBrushCreate(0, 200, 255))
